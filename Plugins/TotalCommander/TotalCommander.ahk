TotalCommander:
    ...
    vim.Map("h", "<cm_FocusLeft>","TTOTAL_CMD")
    ...
    vim.Map("l", "<cm_FocusRight>", "TTOTAL_CMD")
    ...
    vim.Map(";", "<cm_DirectoryHotlist>", "TTOTAL_CMD")
        ...
        vim.Map("<c-l>", "<cm_SwitchToNextTab>","TTOTAL_CMD")
        vim.Map("<c-h>", "<cm_SwitchToPreviousTab>","TTOTAL_CMD")
