TotalCommander:
    ...
    vim.Map("<esc>", "<TC_NormalMode>", "TTOTAL_CMD")
    vim.Map("<c-c>", "<TC_NormalMode>","TTOTAL_CMD")

    vim.Mode("normal", "TTOTAL_CMD")

    vim.Map("fo", "<cm_CopyOtherpanel>", "TTOTAL_CMD")
    vim.Map("fm", "<cm_MoveOnly>", "TTOTAL_CMD")

    vim.Map("fqc", "<TC_CopyUseQueues>", "TTOTAL_CMD")
    vim.Map("fqx", "<TC_MoveUseQueues>", "TTOTAL_CMD")

    vim.Map("fp", "<cm_UnpackFiles>", "TTOTAL_CMD")
    vim.Map("fP", "<cm_PackFiles>", "TTOTAL_CMD")
    vim.Map("fc", "<cm_CopyToClipboard>", "TTOTAL_CMD")
    vim.Map("fx", "<cm_CutToClipboard>", "TTOTAL_CMD")
    vim.Map("fv", "<cm_PasteFromClipboard>", "TTOTAL_CMD")
    vim.Map("fy", "<cm_CopyNamesToClip>", "TTOTAL_CMD")
    vim.Map("fY", "<cm_CopyFullNamesToClip>", "TTOTAL_CMD")
    ...
    vim.Map("a", "<cm_SelectCurrentExtension>","TTOTAL_CMD")
    vim.Map("A", "<cm_SelectCurrentName>","TTOTAL_CMD")
    vim.Map("}", "<cm_UnSelectCurrentExtension>","TTOTAL_CMD")
    ;vim.Map("b", "<space>","TTOTAL_CMD")
    vim.Map("b", "<cm_Reverse>","TTOTAL_CMD")
    vim.Map("B", "<cm_SelectAll>","TTOTAL_CMD")
    vim.Map("c", "<cm_ClearAll>","TTOTAL_CMD")
    vim.Map("C", "<cm_ExchangeSelection>","TTOTAL_CMD")
    vim.Map("d", "<cm_Return>","TTOTAL_CMD")
    vim.Map("D", "<cm_OpenDesktop>","TTOTAL_CMD")
    vim.Map("e", "<cm_Edit>","TTOTAL_CMD")
    vim.Map("E", "<cm_ExeCuteDOS>","TTOTAL_CMD")
    vim.Map("F", "<cm_SearchFor>","TTOTAL_CMD")
    ...
    vim.Map("P", "<cm_CopyOtherpanel>", "TTOTAL_CMD")
    ...
    vim.Map("W", "<cm_ListInternalOnly>","TTOTAL_CMD")
    vim.Map("x", "<TC_ForceDelete>", "TTOTAL_CMD")
    vim.Map("X", "<cm_Delete>", "TTOTAL_CMD")
    vim.Map("y", "<cm_CopyToClipboard>", "TTOTAL_CMD")
    vim.Map("Y", "<cm_CutToClipboard>", "TTOTAL_CMD")
    ...
    vim.Map(";", "<cm_DirectoryHotlist>", "TTOTAL_CMD")
        ...
        vim.Map(":", "<cm_CommandBrowser>","TTOTAL_CMD")
        ...
        vim.Map("gd","<cm_SrcOpenDrives>","TTOTAL_CMD")
        vim.Map("g$", "<TC_LastLine>", "TTOTAL_CMD")
        ...
        vim.Map("<c-h>", "<cm_FocusLeft>","TTOTAL_CMD")
        vim.Map("<c-j>", "<cm_SwitchToPreviousTab>","TTOTAL_CMD")
        vim.Map("<c-k>", "<cm_SwitchToNextTab>","TTOTAL_CMD")
        vim.Map("<c-l>", "<cm_FocusRight>","TTOTAL_CMD")
        vim.Map("to", "<cm_OpenNewTab>","TTOTAL_CMD")
        vim.Map("tO", "<cm_OpenNewTabBg>","TTOTAL_CMD")
        vim.Map("tr", "<TC_ReOpenTab>", "TTOTAL_CMD")
        vim.Map("te", "<cm_Exchange>","TTOTAL_CMD")
        vim.Map("tw", "<cm_ExchangeWithTabs>","TTOTAL_CMD")
        vim.Map("tn", "<cm_OpenDirInNewTab>","TTOTAL_CMD")
        vim.Map("tT", "<cm_OpenDirInNewTabOther>","TTOTAL_CMD")
        vim.Map("th", "<cm_SwitchToPreviousTab>","TTOTAL_CMD")
        vim.Map("tj", "<cm_SwitchToPreviousTab>","TTOTAL_CMD")
        vim.Map("tk", "<cm_SwitchToNextTab>","TTOTAL_CMD")
        vim.Map("tl", "<cm_SwitchToNextTab>","TTOTAL_CMD")
        vim.Map("tc", "<cm_CloseCurrentTab>","TTOTAL_CMD")
        vim.Map("ta", "<cm_CloseAllTabs>","TTOTAL_CMD")
        vim.Map("tm", "<cm_DirTabsShowMenu>","TTOTAL_CMD")
        vim.Map("tL", "<cm_ToggleLockCurrentTab>","TTOTAL_CMD")
        ;vim.Map("tL", "<cm_ToggleLockDcaCurrentTab>","TTOTAL_CMD")
        vim.Map("t1", "<cm_SrcActivateTab1>", "TTOTAL_CMD")
        vim.Map("t2", "<cm_SrcActivateTab2>", "TTOTAL_CMD")
        vim.Map("t3", "<cm_SrcActivateTab3>", "TTOTAL_CMD")
        vim.Map("t4", "<cm_SrcActivateTab4>", "TTOTAL_CMD")
        vim.Map("t5", "<cm_SrcActivateTab5>", "TTOTAL_CMD")
        vim.Map("t6", "<cm_SrcActivateTab6>", "TTOTAL_CMD")
        vim.Map("t7", "<cm_SrcActivateTab7>", "TTOTAL_CMD")
        vim.Map("t8", "<cm_SrcActivateTab8>", "TTOTAL_CMD")
        vim.Map("t9", "<cm_SrcActivateTab9>", "TTOTAL_CMD")
        vim.Map("t0", "<TC_GoLastTab>", "TTOTAL_CMD")
        vim.Map("tt", "<TC_GoLastTab>", "TTOTAL_CMD")
